    ...
    , ui(new Ui::PictureManager)
{
    ...
    connect(ui->addPics, &QPushButton::pressed, this, &PictureManager::selectPictures);
    connect(ui->rmPics, &QPushButton::pressed, this, &PictureManager::removePictures);
    connect(ui->mvUp, &QPushButton::pressed, ui->picTable, &PictureList::moveUp);
    connect(ui->mvDown, &QPushButton::pressed, ui->picTable, &PictureList::moveDown);
